    ...
    if (imageUrl && imageUrl.startsWith("http")) {
      ...
      if (ai) {
        ...
        const profile = {
          ...
          annualIncomeINR: parsed.citizenProfile?.annualIncomeINR || 38e3,
        ...
        const { matchedSchemes: matchedSchemes2, summary: summary2 } = matchCitizenToSchemes(profile);
        scanResult = { citizenProfile: profile, matchedSchemes: matchedSchemes2, summary: summary2 };
      }
    }
    if (!scanResult) {
